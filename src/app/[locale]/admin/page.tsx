...
const SECTION_KEYS = [
  ...
  { key: "teamManagement", href: "/admin/team", icon: "🧑‍🤝‍🧑", color: "from-lime-500 to-emerald-600" },
  { key: "partnerProgram", href: "/admin/partner-tiers", icon: "🤝", color: "from-indigo-500 to-blue-600" },
