    ...
    <div>
      ...
      <section className="gradient-hero py-12">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { label: "Booth Bookings", value: bookings.length, icon: "🏗️" },
      ...
      <section className="py-10 bg-gray-50">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 mb-10">
            ...
            <Link href="/exhibitor/ex-1" className="flex items-start gap-4 p-6 rounded-2xl bg-white border border-gray-100 shadow-sm card-hover">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Build your exhibitor microsite</p>
              </div>
            </Link>
            <div className="flex items-start gap-4 p-6 rounded-2xl bg-white border border-gray-100 shadow-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900">Leads & CRM</h3>
                <p className="text-sm text-gray-500 mt-1">View captured leads</p>
          ...
          {/* Bookings */}
          <h2 className="text-xl font-bold text-gray-900 mb-5">My Booth Bookings</h2>
          {bookings.length === 0 ? (
              ...
              {bookings.map((bk) => (
                <div key={bk.id} className="flex items-center justify-between rounded-2xl bg-white p-6 shadow-sm border border-gray-100">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-gray-900">Booth {bk.boothId.split("-").pop()}</p>
                      <p className="text-sm text-gray-500">Booked {new Date(bk.createdAt).toLocaleDateString()}</p>
                    </div>
                  </div>
