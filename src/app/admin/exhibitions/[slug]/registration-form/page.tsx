    ...
    <div>
      <section className="gradient-hero py-12">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <h1 className="text-3xl font-extrabold text-white">{exhibition ? `${exhibition.title} — Registration Form` : "Registration Form"}</h1>
          <p className="mt-1 text-emerald-200/80">Control whether registration is open, and what this exhibition asks Buyers/Visitors.</p>
        </div>
      </section>
          ...
          {loading ? (
            ...
            <>
              <div className="bg-white rounded-2xl p-6 shadow-sm flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    {enabled ? "Buyers and visitors can register for this exhibition." : "Registration is closed — the \"Register to Attend\" button is hidden."}
                  </p>
                </div>
                <button
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <h2 className="font-bold text-gray-900 mb-4">Registration Form</h2>
                <div className="grid grid-cols-2 gap-3 mb-6">
                  ...
                  >
                    <p className="font-semibold text-gray-900">Default Buyer/Visitor Form</p>
                    <p className="text-xs text-gray-500 mt-1">The standard form: company info, purpose of visit, documents, etc.</p>
                  </button>
                  <button
                    onClick={() => setUsingDefault(false)}
                    className={`p-4 rounded-xl border-2 text-left transition-all ${!usingDefault ? "border-emerald-500 bg-emerald-50" : "border-gray-200 hover:border-gray-300"}`}
                  >
                    <p className="font-semibold text-gray-900">Custom Form</p>
                    <p className="text-xs text-gray-500 mt-1">Build your own questions specific to this exhibition.</p>
                  </button>
                </div>
