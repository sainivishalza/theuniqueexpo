  ...
  return (
    <main className="flex min-h-[calc(100vh-52px)] items-center justify-center px-4">
      <div className="w-full max-w-md space-y-6">
        <h1 className="text-center text-2xl font-bold">Log in to ExpoBridge</h1>
        ...
        <div className="flex rounded border border-gray-300">
          <button
            ...
            className={`flex-1 py-2 text-sm font-medium ${method === "phone" ? "bg-black text-white" : "text-gray-700 hover:bg-gray-50"}`}
          >
            Phone OTP
          </button>
          <button
            onClick={() => setMethod("email")}
            className={`flex-1 py-2 text-sm font-medium ${method === "email" ? "bg-black text-white" : "text-gray-700 hover:bg-gray-50"}`}
          >
            Email Magic Link
          </button>
        </div>
