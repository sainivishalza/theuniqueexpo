    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-emerald-600 via-teal-600 to-purple-700 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16 text-white">
          ...
          <div className="mt-10 grid grid-cols-3 gap-6">
            <div><div className="text-3xl font-extrabold">20+</div><div className="text-sm text-emerald-200">{t("stats.exhibitions")}</div></div>
            <div><div className="text-3xl font-extrabold">5</div><div className="text-sm text-emerald-200">{t("stats.tours")}</div></div>
            <div><div className="text-3xl font-extrabold">6</div><div className="text-sm text-emerald-200">{t("stats.services")}</div></div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <h2 className="text-3xl font-extrabold text-gray-900 mb-2">{t("welcomeBack")}</h2>
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-500">{t("noAccount")}{" "}
              <Link href="/register" className="font-semibold text-emerald-600 hover:text-emerald-700">{t("createOne")}</Link>
            </p>
          </div>
        </div>
      </div>
