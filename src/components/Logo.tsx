export default function Logo({ size = "default" }: { size?: "small" | "default" | "large" }) {
  ...
  return (
    <div className="flex items-center gap-2.5 group">
      <div className={`${s.box} rounded-lg bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 flex items-center justify-center text-white font-bold shadow-sm`}>
      ...
      <div className={`${s.brand} font-extrabold tracking-tight text-gray-900 leading-none`}>
        <span className="text-blue-600">The Unique</span> Expo
      </div>
    </div>
  );
}
