...
// WCAG 2 relative luminance / contrast ratio -- used to warn an admin
// before they save a color combination that would make text unreadable
// (e.g. a light "Hero Color" against the hardcoded white hero headings).
...
// WCAG AA for large/bold text (hero headlines, section titles) is 3:1;
// used as the floor for "would this be hard to read", not full AA
// compliance for body copy.
