...
const features = [
  ...
  { title: "Saved Exhibitions", description: "Exhibitions you've bookmarked", href: "/favorites", icon: "❤️", color: "from-red-400 to-pink-500" },
  ...
  { title: "Messages", description: "Conversations with exhibitors", href: "/messages", icon: "💬", color: "from-pink-500 to-rose-500" },
